    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex items-center">
            ...
            <a href="#" class="flex items-center justify-between mr-4">
                <img src="{{ asset('assets/img/static/pcc.png') }}" width="30px" alt="Logo PCC">
                <span class="self-center font-medium whitespace-nowrap dark:text-white ps-4">Dashboard Regenerasi
                    2024</span>
            </a>
        </div>
        <div class="hidden md:flex md:items-center md:order-2">
            <button type="button"
